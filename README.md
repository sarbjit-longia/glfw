...
- Added support for embedding windows in existing native platform windows
- Added `glfwGetWindowNativeHandle` function for getting the underlying
  platform-specific native window handle
- Added `glfwWindowHintPointer` function for setting window hints with pointer
  values

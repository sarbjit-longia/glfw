...
/*! @addtogroup init
 *  @{ */
#define GLFW_COCOA_CHDIR_RESOURCES  0x00050001
#define GLFW_COCOA_CREATE_MENUBAR   0x00050002
/*! @} */
 ...
 *  setting new hint values will not affect behavior until the next time it is
 ...
 *  menu bar can be disabled with the @ref GLFW_COCOA_CREATE_MENUBAR init hint.
 *
